...
//        model.saveSerialized(modelPath);
        ...
        // java -cp "*" edu.stanford.nlp.sentiment.BuildBinarizedDataset -sentimentModel edu/stanford/nlp/models/sentiment/sentiment.ser.gz -input preBinarized.txt > trainingInput.txt
