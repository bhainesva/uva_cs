...
Inductive Hypothesis: Assume that for all $n\le m$ for some integer $m\ge 1$. 
...
Thus
$$\left[\sum\limits_{k=1}^m \frac{x_k}{10^{m+1}}\right] + \frac{x_{m+1}}{10^{m+1}} \le x  < \left[\sum\limits_{k=1}^m \frac{x_k}{10^k}\right] + \frac{x_{m+1}}{10^{m+1}} + \frac{1}{10^{m+1}}$$
$$\Downarrow$$
$$\sum\limits_{k=1}^{m+1} \frac{x_k}{10^{m+1}} \le x  < \sum\limits_{k=1}^{m+1} \frac{x_k}{10^k} + \frac{1}{10^{m+1}}$$
