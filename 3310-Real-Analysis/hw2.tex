...
\part
It is clear from the definition of $S$ that it is a subset of $\mathbb R$. In order to show that $S = [a, b]$ is closed we must show that $S\setminus mathbb R$ is open. $S\setminus mathbb R = \Set{x\in R : x < a\text{ or }x > b}$. So the complement of $S$ can be written as the union of the two open intervals $(-\infty, a)$ and $(b, \infty)$. By the result of part a this is an open subset of $\mathbb R$ and so $S$ is closed.
