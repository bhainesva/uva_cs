...
/** @brief  Contains names of places in Middle Earth.
 *
...
* @param length The number of cities we wish to visit.
* @return A vector containing the names of cities to be visited.
*/
